...
export default function AuthCallbackPage() {
  ...
  const [post_auth_redirect, set_post_auth_redirect] = useState('/');
  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        ...
        const redirect_path = safe_redirect_path(state_payload?.redirect);
        set_post_auth_redirect(redirect_path);
